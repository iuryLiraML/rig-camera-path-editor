...
function capture() {
  ...
  return {
    ...
    rig: {
      ...
      freqKeys: r.freqKeys,
      targetXKeys: r.targetXKeys,
      targetYKeys: r.targetYKeys,
      targetZKeys: r.targetZKeys,
      lookOffset: r.lookOffset,
      lookOffsetXKeys: r.lookOffsetXKeys,
      lookOffsetYKeys: r.lookOffsetYKeys,
      lookOffsetZKeys: r.lookOffsetZKeys,
      staticPosXKeys: r.staticPosXKeys,
      staticPosYKeys: r.staticPosYKeys,
      staticPosZKeys: r.staticPosZKeys,
      staticRotXKeys: r.staticRotXKeys,
      staticRotYKeys: r.staticRotYKeys,
      staticRotZKeys: r.staticRotZKeys,
